  ...
  - **Given:** The agent has just created the `ACTIVE_PR.json` file.
    ...
    - **`ACTIVE_PR.json`:**
      ```json
      {
        ...
        "tasks": [
          { "taskName": "First task", "status": "TODO", "tdd_steps": [] }
        ]
      }
      ```
        ...
        "tasks": [
          {
            ...
            "tdd_steps": [
              {
                "type": "RED",
                "description": "Write a failing test for the core function.",
                "status": "TODO"
              }
            ]
          }
        ...
        "tasks": [
          {
            ...
            "tdd_steps": [
              ...
              {
                "type": "GREEN",
                "description": "Implement the function to make the test pass.",
                "status": "TODO"
              }
            ]
          }
        ...
        "tasks": [
          {
            "taskName": "...",
            "status": "TODO",
            "tdd_steps": [{ "type": "RED", "status": "TODO" }]
          }
        ]
      }
      ```
        ...
        "tasks": [
          {
            "taskName": "...",
            "status": "TODO",
            "tdd_steps": [{ "type": "GREEN", "status": "TODO" }]
          }
        ]
      }
      ```
    ...
    - **`ACTIVE_PR.json`:**
      ```json
      {
        "tasks": [
          ...
          {
            "taskName": "Address code review feedback: ...",
            "status": "TODO",
            "tdd_steps": [{ "status": "TODO" }]
          }
        ]
      }
      ```
  ...
  - **Given:** State is `DEBUGGING` with `debug_attempt_counter: 1`.
    - **`ORCHESTRATION_STATE.json`:**
      ```json
      {
        ...
        "last_error": "Test failed unexpectedly"
      }
      ```
  - **When:** `get_task` is called.
...
- **Transition:** `FINALIZE_COMPLETE` -> Get "Update Plan" Instruction
  - **Given:** State is `FINALIZE_COMPLETE`.
    ...
    - **`ACTIVE_PR.json`:**
      ```json
      {
        "masterPlanPath": "docs/plans/the-plan.md",
        "tasks": [{ "status": "DONE" }]
      }
      ```
  - **When:** `get_task` is called.
  ...
  - **Given:** State is `MERGING_BRANCH` and the feature branch has a merge conflict.
    - **`ORCHESTRATION_STATE.json`:**
      ```json
      {
        ...
        "current_pr_branch": "feat/conflicting-feature"
      }
      ```
